...
export class CureService {
    ...
    // ==========================================
    // Projects (separate from CuReD projects)
    // ==========================================

    listProjects(): Observable<ProjectPreview[]> {
        return this.http.get<ProjectPreview[]>(
            `${environment.apiUrl}${this.baseUrl}/projects/list`
        );
    }

    createProject(name: string): Observable<number> {
        return this.http.post<number>(
            `${environment.apiUrl}${this.baseUrl}/projects/create`,
            { name }
        );
    }

    renameProject(projectId: number, name: string): Observable<{ updated: boolean }> {
    ...
    deleteProject(projectId: number): Observable<{ deleted: boolean }> {
