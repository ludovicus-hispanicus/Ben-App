# Canvas Architecture (app-new)

> Reference document for AI agents. Describes the Fabric.js-based canvas system used for image viewing, annotation, and bounding-box editing across the Angular app in `app-new/`.
...
Defined in `app-new/src/app/app-routing.module.ts`:
